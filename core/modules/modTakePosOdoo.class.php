 ...
 *
 *  \file       htdocs/takepos/core/modules/modTakePosOdoo.class.php
 *  \ingroup    takepos
 ...
 */
class modTakePosOdoo extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 449090;		// TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'takeposodoo';
		...
		$this->description = "Odoo theme for TakePOS";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Odoo theme for TakePOS";
        ...
        */
		...
		$this->menu[$r++]=array('fk_menu'=>'',			                // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'titre'=>'TakePos Odoo Theme',
								'mainmenu'=>'takepos',
								'leftmenu'=>'',
								'url'=>'/TakeposOdooTheme/takepos.php',
