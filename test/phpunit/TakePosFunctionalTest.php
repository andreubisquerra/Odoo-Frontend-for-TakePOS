...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTakePosOdoo')->click();
		} else {
			// Disable the module
			$this->byHref('modTakePosOdoo')->click();
			// Reenable the module
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTakePosOdoo_TakePosTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTakePosOdoo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
